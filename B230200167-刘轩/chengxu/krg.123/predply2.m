function py = predply2(px,rs,f,alfa)
%PREDPLY   Response surface method prediction for regressed y = f(x).
%
%          Dimensional mapping:
%          Y    1D
%          X    pD
...
%               PSIG the esitmated residual sigma
...
% save data
save predply.mat ps;
end % function ps = predply(px,rs,f,alfa)
